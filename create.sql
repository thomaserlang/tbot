...
-- Sun 29 Jul 2018 04:08:43 PM CEST
...
-- -----------------------------------------------------
-- Table `tbot`.`twitch_discord_roles`
-- -----------------------------------------------------
...
-- Table `tbot`.`spotify`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tbot`.`spotify` (
