...
down_revision: Union[str, None] = 'dba3882e4560'
...
def upgrade() -> None:
    ...
    op.add_column('chatlogs', sa.Column('provider', sa.String(100)))
    ...
    op.add_column('chatlog_chatters', sa.Column('provider', sa.String(100)))
    ...
    op.add_column('chatlogs', sa.Column('user_display_name', sa.String(100)))
    ...
    op.alter_column('chatlogs', 'msg_id', nullable=False, existing_type=sa.String(36))
    ...
    op.add_column('chatlogs', sa.Column('sub_type', sa.String(100), nullable=True))
