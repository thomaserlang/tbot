...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('viewer_name', sa.String(200), nullable=False),
        sa.Column('viewer_display_name', sa.String(200), nullable=False),
        sa.Column('viewer_color', sa.String(7), nullable=True),
        sa.Column('message', sa.String(2000), nullable=False),
        sa.Column('msg_id', sa.String(255), nullable=True),
