...
def queue_queue_key(*, channel_queue_id: UUID) -> str:
...
async def publish_queue_viewer_created(
    ...
    key = queue_queue_key(channel_queue_id=channel_queue_viewer.channel_queue_id)
    event = QueueEvent(
...
async def publish_queue_cleared(channel_queue_id: UUID) -> None:
    key = queue_queue_key(channel_queue_id=channel_queue_id)
    event = QueueEvent(
